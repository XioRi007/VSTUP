...
export const AuthPage = ()=>{
    ...
    const submitHandler = async (e)=>{
        ...
        try{
            ...
            alert.show('Вход выполнен', 'success');
        ...
        <div className="container p-5" style={{minHeight:'650px'}}>        
            ...
            <div className="row justify-content-center" >    
                ...
                <div className="form-floating mb-3">
                    <input type="email" className="form-control" id="floatingInput" name='Email' placeholder="name@example.com" value={form.Email} onChange={changeHandler} required/>
                    <label htmlFor="floatingInput">Email address</label>                    
                </div>
                <div className="form-floating">
                    <input type="password" className="form-control" id="floatingPassword" name='Password' placeholder="Password" value={form.Password}onChange={changeHandler} required/>
